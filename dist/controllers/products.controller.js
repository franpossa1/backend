...
exports.updateProduct = exports.getProducts = exports.getProductById = exports.deleteProductById = exports.createNewProduct = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          pool = _context2.sent;
          _context2.next = 9;
          return pool.request().input("name", _database.sql.VarChar, name).input("description", _database.sql.VarChar, description).input("quantity", _database.sql.Int, quantity).query(_database.queries.createNewProduct);
        case 9:
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          pool = _context3.sent;
          _context3.next = 7;
          return pool.request().input("id", _database.sql.Int, id).query(_database.queries.getProductById);
        case 7:
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 4:
          pool = _context4.sent;
          _context4.next = 7;
          return pool.request().input("id", _database.sql.Int, id).query(_database.queries.deleteProductById);
        case 7:
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 7:
          pool = _context5.sent;
          _context5.next = 10;
          return pool.request().input("name", _database.sql.VarChar, name).input("description", _database.sql.VarChar, description).input("quantity", _database.sql.Int, quantity).input("id", _database.sql.Int, id).query(_database.queries.createNewProduct);
        case 10:
          console.log(name, description, quantity);
          res.json(name, description, quantity);
          _context5.next = 18;
